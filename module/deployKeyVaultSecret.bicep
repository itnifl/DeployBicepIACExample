...
resource secret 'Microsoft.KeyVault/vaults/secrets@2019-09-01' = if(resourceExists == false) {
  name: name
  parent: keyVault
  tags: tags
  properties: {
...
module secret_rbac 'set_secret_rbac.bicep' = [for (roleAssignment, index) in roleAssignments: if(resourceExists == false) {
